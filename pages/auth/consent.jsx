...
export default function Consent({ action, consentRequest, csrfToken, message }) {
  return (
    <>
      <h1>Give consent:</h1>
      <form
      ...
      >
        ...
        <p>
          Client <strong>{consentRequest.client?.client_name || consentRequest.client?.client_id}</strong> wants to access your resources on your behalf and to:
        </p>
        ...
        <ul>
          {consentRequest.client?.policy_uri && <li><a href={client.policy_uri}>Policy</a></li>}
          {consentRequest.client?.tos_uri && <li><a href={client.tos_uri}>Terms of Service</a></li>}
        </ul>
        <div>
