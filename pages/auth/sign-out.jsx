...
export async function getServerSideProps({ req, res, query }) {
  ...
  try {
    const logoutRequestResponse = await hydraAdmin.getLogoutRequest(logout_challenge);
  } catch (e) {
  ...
  if (req.method === 'POST') {
    ...
    if (formData.button === 'cancel') {
      ...
      const rejectLogoutRequestResponse = await hydraAdmin.rejectLogoutRequest(logout_challenge);
